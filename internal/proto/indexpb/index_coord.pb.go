...
type SegmentIndex struct {
	...
	// TODO: @foxspy
	KnowhereMinimalVersion int32    `protobuf:"varint,17,opt,name=knowhere_minimal_version,json=knowhereMinimalVersion,proto3" json:"knowhere_minimal_version,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (m *SegmentIndex) GetKnowhereMinimalVersion() int32 {
	if m != nil {
...
func (m *IndexFilePathInfo) GetKnowhereMinimalVersion() int32 {
	if m != nil {
		return m.KnowhereMinimalVersion
	}
	return 0
...
type CreateJobRequest struct {
	...
	// TODO: @foxspy
	KnowhereMinimalVersion int32    `protobuf:"varint,13,opt,name=knowhere_minimal_version,json=knowhereMinimalVersion,proto3" json:"knowhere_minimal_version,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (m *CreateJobRequest) GetKnowhereMinimalVersion() int32 {
	if m != nil {
		return m.KnowhereMinimalVersion
	}
	return 0
...
var fileDescriptor_f9e019eb3fda53c2 = []byte{
	...
	,
}
