...
type CreateJobRequest struct {
	...
	ExternalSource string `protobuf:"bytes,34,opt,name=external_source,json=externalSource,proto3" json:"external_source,omitempty"`
	ExternalSpec   string `protobuf:"bytes,35,opt,name=external_spec,json=externalSpec,proto3" json:"external_spec,omitempty"`
	// Path format version for index files on object storage.
	// See milvus.proto.index.IndexStorePathVersion for value semantics.
	IndexStorePathVersion indexpb.IndexStorePathVersion `protobuf:"varint,36,opt,name=index_store_path_version,json=indexStorePathVersion,proto3,enum=milvus.proto.index.IndexStorePathVersion" json:"index_store_path_version,omitempty"`
}
...
func (x *CreateJobRequest) GetExternalSource() string {
	if x != nil {
...
func (x *CreateJobRequest) GetExternalSpec() string {
	if x != nil {
...
func (x *CreateJobRequest) GetIndexStorePathVersion() indexpb.IndexStorePathVersion {
	if x != nil {
...
type AnalyzeRequest struct {
	...
	EnableGlobalIndex   bool                                 `protobuf:"varint,20,opt,name=enable_global_index,json=enableGlobalIndex,proto3" json:"enable_global_index,omitempty"`
	InsertChannel       string                               `protobuf:"bytes,21,opt,name=insert_channel,json=insertChannel,proto3" json:"insert_channel,omitempty"`
	SegmentStorageInfos map[int64]*AnalyzeSegmentStorageInfo `protobuf:"bytes,22,rep,name=segment_storage_infos,json=segmentStorageInfos,proto3" json:"segment_storage_infos,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Target max/min rows per AnalyzeV2 compaction group, resolved on datacoord
	// (instance-visible config). Worker-side paramtable is only a fallback when zero.
	CompactionMaxRows int64 `protobuf:"varint,23,opt,name=compaction_max_rows,json=compactionMaxRows,proto3" json:"compaction_max_rows,omitempty"`
	CompactionMinRows int64 `protobuf:"varint,24,opt,name=compaction_min_rows,json=compactionMinRows,proto3" json:"compaction_min_rows,omitempty"`
}
...
func (x *AnalyzeRequest) GetEnableGlobalIndex() bool {
	if x != nil {
...
func (x *AnalyzeRequest) GetInsertChannel() string {
	if x != nil {
...
func (x *AnalyzeRequest) GetSegmentStorageInfos() map[int64]*AnalyzeSegmentStorageInfo {
	if x != nil {
...
func (x *AnalyzeRequest) GetCompactionMaxRows() int64 {
	if x != nil {
...
func (x *AnalyzeRequest) GetCompactionMinRows() int64 {
	if x != nil {
...
type AnalyzeSegmentStorageInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	InsertLogs     []*datapb.FieldBinlog `protobuf:"bytes,2,rep,name=insert_logs,json=insertLogs,proto3" json:"insert_logs,omitempty"`
	Manifest       string                `protobuf:"bytes,3,opt,name=manifest,proto3" json:"manifest,omitempty"`
}

func (x *AnalyzeSegmentStorageInfo) Reset() {
	*x = AnalyzeSegmentStorageInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *AnalyzeSegmentStorageInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnalyzeSegmentStorageInfo) ProtoMessage() {}

func (x *AnalyzeSegmentStorageInfo) ProtoReflect() protoreflect.Message {
	mi := &file_worker_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AnalyzeSegmentStorageInfo.ProtoReflect.Descriptor instead.
func (*AnalyzeSegmentStorageInfo) Descriptor() ([]byte, []int) {
	return file_worker_proto_rawDescGZIP(), []int{11}
}

func (x *AnalyzeSegmentStorageInfo) GetStorageVersion() int64 {
	if x != nil {
		return x.StorageVersion
	}
	return 0
...
func (x *AnalyzeSegmentStorageInfo) GetInsertLogs() []*datapb.FieldBinlog {
	if x != nil {
		return x.InsertLogs
	}
	return nil
...
func (x *AnalyzeSegmentStorageInfo) GetManifest() string {
	if x != nil {
		return x.Manifest
	}
	return ""
...
func (x *IndexTaskInfo) GetIndexStorePathVersion() indexpb.IndexStorePathVersion {
	if x != nil {
		return x.IndexStorePathVersion
	}
	return indexpb.IndexStorePathVersion(0)
...
type AnalyzeResult struct {
	...
	GlobalStatsIndexRoot string           `protobuf:"bytes,5,opt,name=global_stats_index_root,json=globalStatsIndexRoot,proto3" json:"global_stats_index_root,omitempty"`
	HeadIndexFile        string           `protobuf:"bytes,6,opt,name=head_index_file,json=headIndexFile,proto3" json:"head_index_file,omitempty"`
	CompactionPlanFile   string           `protobuf:"bytes,7,opt,name=compaction_plan_file,json=compactionPlanFile,proto3" json:"compaction_plan_file,omitempty"`
}
...
func (x *AnalyzeResult) GetGlobalStatsIndexRoot() string {
	if x != nil {
...
func (x *AnalyzeResult) GetHeadIndexFile() string {
	if x != nil {
...
func (x *AnalyzeResult) GetCompactionPlanFile() string {
	if x != nil {
...
var file_worker_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xb9, 0x0c, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4a,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x72, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x48, 0x0a, 0x0e, 0x70, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x20, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	0x22, 0x4a, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4a, 0x6f, 0x62, 0x73, 0x52, 0x65, 0x71,
	...
	0x03, 0x28, 0x03, 0x52, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x73, 0x22, 0xaa, 0x01, 0x0a,
	...
	0x6e, 0x64, 0x65, 0x78, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x49, 0x0a, 0x0f, 0x44, 0x72, 0x6f,
	...
	,
	...
	0x61, 0x78, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1b, 0x0a,
	0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x12, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x48, 0x0a, 0x0e, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x13, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	,
	...
	0x75, 0x0a, 0x18, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b,
	0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x43, 0x0a,
	...
	,
	...
	0x6f, 0x67, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x1a,
	0x0a, 0x08, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x6d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22, 0xbd, 0x0c, 0x0a, 0x12, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49,
	0x44, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	0x49, 0x44, 0x12, 0x3f, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x5f, 0x6c, 0x6f, 0x67,
	...
	0x6f, 0x67, 0x73, 0x12, 0x3d, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x74, 0x61, 0x5f, 0x6c, 0x6f, 0x67,
	...
	0x67, 0x73, 0x12, 0x48, 0x0a, 0x0e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6d, 0x69, 0x6c,
	0x76, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x2e,
	...
	0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6d,
	...
	,
	...
	,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x19, 0x63, 0x75, 0x72, 0x72,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x1b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e,
	...
	,
	...
	0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x22, 0xf8, 0x02, 0x0a, 0x12, 0x43,
	...
	0x79, 0x70, 0x65, 0x52, 0x07, 0x6a, 0x6f, 0x62, 0x54, 0x79, 0x70, 0x65, 0x22, 0xfa, 0x03, 0x0a,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x32, 0x0a, 0x13, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x03, 0x42, 0x02, 0x18, 0x01, 0x52, 0x11, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x53, 0x74, 0x6f,
	...
	0x65, 0x6e, 0x74, 0x53, 0x63, 0x61, 0x6c, 0x61, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x62, 0x0a, 0x18, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x5f, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x6d, 0x69, 0x6c, 0x76, 0x75, 0x73,
	...
	0x6f, 0x6e, 0x52, 0x15, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x61,
	0x74, 0x68, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x4e, 0x0a, 0x0f, 0x49, 0x6e, 0x64,
	...
	0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0xb4, 0x02, 0x0a, 0x0d, 0x41, 0x6e,
	0x61, 0x6c, 0x79, 0x7a, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0d, 0x68, 0x65, 0x61, 0x64, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x30,
	0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x6c, 0x61,
	0x6e, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x63, 0x6f,
	0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6c, 0x61, 0x6e, 0x46, 0x69, 0x6c, 0x65,
...
var file_worker_proto_goTypes = []interface{}{
	...
	(*AnalyzeSegmentStorageInfo)(nil),   // 11: milvus.proto.index.AnalyzeSegmentStorageInfo
	(*CreateStatsRequest)(nil),          // 12: milvus.proto.index.CreateStatsRequest
	(*CreateJobV2Request)(nil),          // 13: milvus.proto.index.CreateJobV2Request
	(*QueryJobsV2Request)(nil),          // 14: milvus.proto.index.QueryJobsV2Request
	(*IndexTaskInfo)(nil),               // 15: milvus.proto.index.IndexTaskInfo
	(*IndexJobResults)(nil),             // 16: milvus.proto.index.IndexJobResults
	(*AnalyzeResult)(nil),               // 17: milvus.proto.index.AnalyzeResult
	(*AnalyzeResults)(nil),              // 18: milvus.proto.index.AnalyzeResults
	(*StatsResult)(nil),                 // 19: milvus.proto.index.StatsResult
	(*StatsResults)(nil),                // 20: milvus.proto.index.StatsResults
	(*QueryJobsV2Response)(nil),         // 21: milvus.proto.index.QueryJobsV2Response
	(*DropJobsV2Request)(nil),           // 22: milvus.proto.index.DropJobsV2Request
	nil,                                 // 23: milvus.proto.index.CreateTaskRequest.PropertiesEntry
	nil,                                 // 24: milvus.proto.index.QueryTaskRequest.PropertiesEntry
	nil,                                 // 25: milvus.proto.index.QueryTaskResponse.PropertiesEntry
	nil,                                 // 26: milvus.proto.index.DropTaskRequest.PropertiesEntry
	nil,                                 // 27: milvus.proto.index.AnalyzeRequest.SegmentStatsEntry
	nil,                                 // 28: milvus.proto.index.AnalyzeRequest.SegmentStorageInfosEntry
	...
	(indexpb.IndexStorePathVersion)(0),  // 38: milvus.proto.index.IndexStorePathVersion
	(*indexpb.JobInfo)(nil),             // 39: milvus.proto.index.JobInfo
	(*schemapb.CollectionSchema)(nil),   // 40: milvus.proto.schema.CollectionSchema
	(indexpb.StatsSubJob)(0),            // 41: milvus.proto.index.StatsSubJob
	(*internalpb.FileResourceInfo)(nil), // 42: milvus.proto.internal.FileResourceInfo
	(indexpb.JobType)(0),                // 43: milvus.proto.index.JobType
	(commonpb.IndexState)(0),            // 44: milvus.proto.common.IndexState
	(indexpb.JobState)(0),               // 45: milvus.proto.index.JobState
	(*indexpb.SegmentStats)(nil),        // 46: milvus.proto.index.SegmentStats
	(*datapb.TextIndexStats)(nil),       // 47: milvus.proto.data.TextIndexStats
	(*datapb.JsonKeyStats)(nil),         // 48: milvus.proto.data.JsonKeyStats
	(*milvuspb.GetMetricsRequest)(nil),  // 49: milvus.proto.milvus.GetMetricsRequest
	(*milvuspb.GetMetricsResponse)(nil), // 50: milvus.proto.milvus.GetMetricsResponse
}
var file_worker_proto_depIdxs = []int32{
	23, // 0: milvus.proto.index.CreateTaskRequest.properties:type_name -> milvus.proto.index.CreateTaskRequest.PropertiesEntry
	24, // 1: milvus.proto.index.QueryTaskRequest.properties:type_name -> milvus.proto.index.QueryTaskRequest.PropertiesEntry
	31, // 2: milvus.proto.index.QueryTaskResponse.status:type_name -> milvus.proto.common.Status
	25, // 3: milvus.proto.index.QueryTaskResponse.properties:type_name -> milvus.proto.index.QueryTaskResponse.PropertiesEntry
	26, // 4: milvus.proto.index.DropTaskRequest.properties:type_name -> milvus.proto.index.DropTaskRequest.PropertiesEntry
	...
	33, // 12: milvus.proto.index.CreateJobRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	38, // 13: milvus.proto.index.CreateJobRequest.index_store_path_version:type_name -> milvus.proto.index.IndexStorePathVersion
	31, // 14: milvus.proto.index.QueryJobsResponse.status:type_name -> milvus.proto.common.Status
	15, // 15: milvus.proto.index.QueryJobsResponse.index_infos:type_name -> milvus.proto.index.IndexTaskInfo
	31, // 16: milvus.proto.index.GetJobStatsResponse.status:type_name -> milvus.proto.common.Status
	39, // 17: milvus.proto.index.GetJobStatsResponse.job_infos:type_name -> milvus.proto.index.JobInfo
	34, // 18: milvus.proto.index.AnalyzeRequest.field_type:type_name -> milvus.proto.schema.DataType
	27, // 19: milvus.proto.index.AnalyzeRequest.segment_stats:type_name -> milvus.proto.index.AnalyzeRequest.SegmentStatsEntry
	32, // 20: milvus.proto.index.AnalyzeRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	36, // 21: milvus.proto.index.AnalyzeRequest.field:type_name -> milvus.proto.schema.FieldSchema
	33, // 22: milvus.proto.index.AnalyzeRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	28, // 23: milvus.proto.index.AnalyzeRequest.segment_storage_infos:type_name -> milvus.proto.index.AnalyzeRequest.SegmentStorageInfosEntry
	37, // 24: milvus.proto.index.AnalyzeSegmentStorageInfo.insert_logs:type_name -> milvus.proto.data.FieldBinlog
	37, // 25: milvus.proto.index.CreateStatsRequest.insert_logs:type_name -> milvus.proto.data.FieldBinlog
	37, // 26: milvus.proto.index.CreateStatsRequest.delta_logs:type_name -> milvus.proto.data.FieldBinlog
	32, // 27: milvus.proto.index.CreateStatsRequest.storage_config:type_name -> milvus.proto.index.StorageConfig
	40, // 28: milvus.proto.index.CreateStatsRequest.schema:type_name -> milvus.proto.schema.CollectionSchema
	41, // 29: milvus.proto.index.CreateStatsRequest.subJobType:type_name -> milvus.proto.index.StatsSubJob
	33, // 30: milvus.proto.index.CreateStatsRequest.plugin_context:type_name -> milvus.proto.common.KeyValuePair
	42, // 31: milvus.proto.index.CreateStatsRequest.file_resources:type_name -> milvus.proto.internal.FileResourceInfo
	43, // 32: milvus.proto.index.CreateJobV2Request.job_type:type_name -> milvus.proto.index.JobType
	10, // 33: milvus.proto.index.CreateJobV2Request.analyze_request:type_name -> milvus.proto.index.AnalyzeRequest
	4,  // 34: milvus.proto.index.CreateJobV2Request.index_request:type_name -> milvus.proto.index.CreateJobRequest
	12, // 35: milvus.proto.index.CreateJobV2Request.stats_request:type_name -> milvus.proto.index.CreateStatsRequest
	43, // 36: milvus.proto.index.QueryJobsV2Request.job_type:type_name -> milvus.proto.index.JobType
	44, // 37: milvus.proto.index.IndexTaskInfo.state:type_name -> milvus.proto.common.IndexState
	38, // 38: milvus.proto.index.IndexTaskInfo.index_store_path_version:type_name -> milvus.proto.index.IndexStorePathVersion
	15, // 39: milvus.proto.index.IndexJobResults.results:type_name -> milvus.proto.index.IndexTaskInfo
	45, // 40: milvus.proto.index.AnalyzeResult.state:type_name -> milvus.proto.index.JobState
	17, // 41: milvus.proto.index.AnalyzeResults.results:type_name -> milvus.proto.index.AnalyzeResult
	45, // 42: milvus.proto.index.StatsResult.state:type_name -> milvus.proto.index.JobState
	37, // 43: milvus.proto.index.StatsResult.insert_logs:type_name -> milvus.proto.data.FieldBinlog
	37, // 44: milvus.proto.index.StatsResult.stats_logs:type_name -> milvus.proto.data.FieldBinlog
	29, // 45: milvus.proto.index.StatsResult.text_stats_logs:type_name -> milvus.proto.index.StatsResult.TextStatsLogsEntry
	37, // 46: milvus.proto.index.StatsResult.bm25_logs:type_name -> milvus.proto.data.FieldBinlog
	30, // 47: milvus.proto.index.StatsResult.json_key_stats_logs:type_name -> milvus.proto.index.StatsResult.JsonKeyStatsLogsEntry
	19, // 48: milvus.proto.index.StatsResults.results:type_name -> milvus.proto.index.StatsResult
	31, // 49: milvus.proto.index.QueryJobsV2Response.status:type_name -> milvus.proto.common.Status
	16, // 50: milvus.proto.index.QueryJobsV2Response.index_job_results:type_name -> milvus.proto.index.IndexJobResults
	18, // 51: milvus.proto.index.QueryJobsV2Response.analyze_job_results:type_name -> milvus.proto.index.AnalyzeResults
	20, // 52: milvus.proto.index.QueryJobsV2Response.stats_job_results:type_name -> milvus.proto.index.StatsResults
	43, // 53: milvus.proto.index.DropJobsV2Request.job_type:type_name -> milvus.proto.index.JobType
	46, // 54: milvus.proto.index.AnalyzeRequest.SegmentStatsEntry.value:type_name -> milvus.proto.index.SegmentStats
	11, // 55: milvus.proto.index.AnalyzeRequest.SegmentStorageInfosEntry.value:type_name -> milvus.proto.index.AnalyzeSegmentStorageInfo
	47, // 56: milvus.proto.index.StatsResult.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	48, // 57: milvus.proto.index.StatsResult.JsonKeyStatsLogsEntry.value:type_name -> milvus.proto.data.JsonKeyStats
	4,  // 58: milvus.proto.index.IndexNode.CreateJob:input_type -> milvus.proto.index.CreateJobRequest
	5,  // 59: milvus.proto.index.IndexNode.QueryJobs:input_type -> milvus.proto.index.QueryJobsRequest
	7,  // 60: milvus.proto.index.IndexNode.DropJobs:input_type -> milvus.proto.index.DropJobsRequest
	8,  // 61: milvus.proto.index.IndexNode.GetJobStats:input_type -> milvus.proto.index.GetJobStatsRequest
	13, // 62: milvus.proto.index.IndexNode.CreateJobV2:input_type -> milvus.proto.index.CreateJobV2Request
	14, // 63: milvus.proto.index.IndexNode.QueryJobsV2:input_type -> milvus.proto.index.QueryJobsV2Request
	22, // 64: milvus.proto.index.IndexNode.DropJobsV2:input_type -> milvus.proto.index.DropJobsV2Request
	49, // 65: milvus.proto.index.IndexNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	0,  // 66: milvus.proto.index.IndexNode.CreateTask:input_type -> milvus.proto.index.CreateTaskRequest
	1,  // 67: milvus.proto.index.IndexNode.QueryTask:input_type -> milvus.proto.index.QueryTaskRequest
	3,  // 68: milvus.proto.index.IndexNode.DropTask:input_type -> milvus.proto.index.DropTaskRequest
	31, // 69: milvus.proto.index.IndexNode.CreateJob:output_type -> milvus.proto.common.Status
	6,  // 70: milvus.proto.index.IndexNode.QueryJobs:output_type -> milvus.proto.index.QueryJobsResponse
	31, // 71: milvus.proto.index.IndexNode.DropJobs:output_type -> milvus.proto.common.Status
	9,  // 72: milvus.proto.index.IndexNode.GetJobStats:output_type -> milvus.proto.index.GetJobStatsResponse
	31, // 73: milvus.proto.index.IndexNode.CreateJobV2:output_type -> milvus.proto.common.Status
	21, // 74: milvus.proto.index.IndexNode.QueryJobsV2:output_type -> milvus.proto.index.QueryJobsV2Response
	31, // 75: milvus.proto.index.IndexNode.DropJobsV2:output_type -> milvus.proto.common.Status
	50, // 76: milvus.proto.index.IndexNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	31, // 77: milvus.proto.index.IndexNode.CreateTask:output_type -> milvus.proto.common.Status
	2,  // 78: milvus.proto.index.IndexNode.QueryTask:output_type -> milvus.proto.index.QueryTaskResponse
	31, // 79: milvus.proto.index.IndexNode.DropTask:output_type -> milvus.proto.common.Status
...
func file_worker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_worker_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AnalyzeSegmentStorageInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
