...
type InsertFiles struct {
	...
	// StorageV2 manifest file path for this segment. When present, C++ side resolves
	// binlog paths from the manifest rather than the legacy insert_files list.
...
func (x *InsertFiles) GetManifestPath() string {
	if x != nil {
...
type AnalyzeInfo struct {
	...
	// When >= 2, KmeansClustering reads raw data via per-segment manifest paths
	// instead of the legacy insert_files list.
	...
	// Optional: minio object path to a pre-computed centroids file.
	// When non-empty, analyze skips the kmeans Fit step, loads centroids from
	// this file via ClusterNode::SetCentroids, and runs streaming assign for
	// every segment (no trained_segments_num shortcut).
	// File format (simple binary): int32 n_clusters | int32 dim | float32[n×dim]
	ExternalCentroidsPath string `protobuf:"bytes,18,opt,name=external_centroids_path,json=externalCentroidsPath,proto3" json:"external_centroids_path,omitempty"`
}
...
func (x *AnalyzeInfo) GetExternalCentroidsPath() string {
	if x != nil {
...
var file_clustering_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x22, 0x55, 0x0a, 0x0b, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x46, 0x69, 0x6c, 0x65,
	...
	0x69, 0x66, 0x65, 0x73, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0xd8, 0x07, 0x0a, 0x0b, 0x41, 0x6e,
	...
	0x61, 0x67, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x36, 0x0a, 0x17, 0x65, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x63, 0x65, 0x6e, 0x74, 0x72, 0x6f, 0x69, 0x64, 0x73,
	0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x65, 0x78, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x43, 0x65, 0x6e, 0x74, 0x72, 0x6f, 0x69, 0x64, 0x73, 0x50, 0x61,
	...
	0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
